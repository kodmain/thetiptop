...
var (
	...
	DB_DSN        string = "sqlite://database.db" // The database connection string, defaults to the value in DEFAULT_DB_DSN.
	//DB_DSN        string = "sqlite://memory"                                         // The database connection string, defaults to the value in DEFAULT_DB_DSN.
)
